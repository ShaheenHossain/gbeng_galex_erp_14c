# Sign the GalexERP CLA

In order for your contribution to GalexERP to be accepted, you have to sign the
GalexERP Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [galex/galex](/galex/galex), adding a new file `<github-login>.md` under the
...
3. An GalexERP R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [galex/galex](/galex/galex), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is GalexERP, the file would be
    `doc/cla/corporate/galex.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the GalexERP Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `galex.com`.  In that case someone from the GalexERP team will
make the pull request on your behalf.

* Printable GalexERP CCLA v1.0 https://www.galex.com/files/legal/GalexERP-CCLA-v1.0.pdf
* Printable GalexERP ICLA v1.0 https://www.galex.com/files/legal/GalexERP-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for GalexERP is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the GalexERP project

* protect the GalexERP project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the GalexERP project and its users from bad actors who would contribute
...
contributor really intended to contribute to the GalexERP project under specific
...
The GalexERP CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, GalexERP to use, modify and
...
(ICLA) of GalexERP.  The agreement is executed by adding your name and
...
removed from the GalexERP project.

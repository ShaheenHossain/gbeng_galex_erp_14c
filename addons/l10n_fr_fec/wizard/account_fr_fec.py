...
from galex.exceptions import UserError, AccessDenied
from galex.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but GalexERP has the label on the account.move.line, so that's a
        # problem !

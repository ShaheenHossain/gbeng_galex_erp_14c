...
from galex.addons.payment_buckaroo.controllers.main import BuckarooController
from galex.tools import mute_logger


@galex.tests.tagged('post_install', '-at_install', 'external', '-standard')
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('galex.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@galex.com',

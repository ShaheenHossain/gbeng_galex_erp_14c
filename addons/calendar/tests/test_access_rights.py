...
from galex.tests.common import SavepointCase, new_test_user
...
class TestAccessRights(SavepointCase):
    ...
    @classmethod
    @mute_logger('galex.tests', 'galex.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    @mute_logger('galex.addons.base.models.ir_rule')

...
from galex.addons.calendar.models.calendar_attendee import Attendee
from galex.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from galex.exceptions import UserError, ValidationError, AccessError
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'GalexERP'

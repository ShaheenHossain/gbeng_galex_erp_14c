...
from galex.tools import html2plaintext, cleanup_xml_node
...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_invoice_line_allowance_vals_list(self, line):
        ...
        Note that allowance charges do not exist for credit notes in UBL 2.0, so if we apply discount in GalexERP
        ...
        allowance_vals = {
            ...
            # A reason should be provided. In GalexERP, we only manage discounts.

...
wget 'https://nightly.galex.com/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.galex.com/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/galex
chown pi:pi /var/log/galex
chown pi:pi -R /home/pi/galex/
...
echo "* * * * * rm /var/run/galex/sessions/*" | crontab -
...
echo "addons/hw_drivers/iot_devices/" > /home/pi/galex/.git/info/exclude

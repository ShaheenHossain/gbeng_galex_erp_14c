...
import galex
from galex import fields, tools
from galex.tools import float_compare, mute_logger, test_reports
from galex.tests.common import Form
from galex.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('galex.addons.point_of_sale.models.pos_order'):

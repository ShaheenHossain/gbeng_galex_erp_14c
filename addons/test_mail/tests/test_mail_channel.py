...
from galex.tests import tagged, Form
...
from galex.exceptions import AccessError, ValidationError, UserError
...
class TestChannelAccessRights(TestMailCommon):
    ...
    @mute_logger('galex.addons.base.models.ir_model', 'galex.models')
    ...
    @mute_logger('galex.addons.base.models.ir_model', 'galex.models', 'galex.models.unlink')
...
class TestChannelFeatures(TestMailCommon):
    ...
    @mute_logger('galex.addons.mail.models.mail_mail', 'galex.models.unlink')
...
class TestChannelModeration(TestMailCommon):
    ...
    @mute_logger('galex.addons.mail.models.mail_channel', 'galex.models.unlink')

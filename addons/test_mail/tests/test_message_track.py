...
from galex.tests.common import tagged
...
class TestTracking(TestMailCommon):
    ...
    def test_create_partner_from_tracking_multicompany(self):
        ...
        with patch('galex.addons.mail.models.mail_thread.MailThread._message_track_post_template', patched_message_track_post_template):

...
from galex.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from galex.addons.test_mail.models.test_mail_models import MailTestSimple
from galex.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from galex.api import call_kw
from galex.exceptions import AccessError
from galex.tests import tagged
from galex.tools import mute_logger, formataddr
...
class TestMessagePost(TestMailCommon, TestRecipients):
    ...
    def test_post_inactive_follower(self):
        # In some case galexbot is follower of a record.
        # Even if it shouldn't be the case, we want to be sure that galexbot is not notified
        (self.user_employee | self.user_admin).write({'notification_type': 'inbox'})
    ...
    @mute_logger('galex.addons.mail.models.mail_mail', 'galex.tests')
    ...
    @mute_logger('galex.addons.mail.models.mail_mail', 'galex.addons.mail.models.mail_thread')

...
from galex.tests.common import users, warmup
...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('galex.models.unlink', 'galex.tests', 'galex.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('galex.tests', 'galex.addons.mail.models.mail_mail', 'galex.models.unlink')

...
from galex.addons.test_mail.models.test_mail_models import MailTestTicket
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('galex.tests', 'galex.addons.mail.models.mail_mail')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('galex.models.unlink', 'galex.addons.mail.models.mail_mail')

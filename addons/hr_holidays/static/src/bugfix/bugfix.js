 ...
 */
galex.define('hr_holidays/static/src/bugfix/bugfix.js', function (require) {
'use strict';

});

// FIXME move me in hr_holidays/static/src/models/partner/partner.js
galex.define('hr_holidays/static/src/models/partner/partner.js', function (require) {
'use strict';
...
registerFieldPatchModel('mail.partner', 'hr/static/src/models/partner/partner.js', {
     ...
     * String is expected to use GalexERP's datetime string format

...
from galex import api, fields, models, SUPERUSER_ID, tools
from galex.addons.base.models.res_partner import _tz_get
from galex.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
from galex.exceptions import AccessError, UserError, ValidationError
from galex.tools import float_compare
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from GalexERPBot (sudo)

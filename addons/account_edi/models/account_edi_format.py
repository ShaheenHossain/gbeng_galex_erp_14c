...
from galex import models, fields, api
from galex.tools.pdf import GalexERPPdfFileReader, GalexERPPdfFileWriter
from galex.osv import expression
from galex.tools import html_escape
from galex.exceptions import RedirectWarning
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The GalexERPPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        if self._is_embedding_to_invoice_pdf_needed() and edi_document.attachment_id:
            pdf_writer.embed_galex_attachment(edi_document.attachment_id)
    ...
    def _embed_edis_to_pdf(self, pdf_content, invoice):
        ...
        if to_embed:
            ...
            reader = GalexERPPdfFileReader(reader_buffer, strict=False)
            writer = GalexERPPdfFileWriter()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = GalexERPPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf

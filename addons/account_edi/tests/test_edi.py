...
class TestAccountEdi(AccountEdiTestCommon):
    ...
    def test_prepare_jobs(self):
        ...
        with patch('galex.addons.account_edi.models.account_edi_format.AccountEdiFormat._support_batching', return_value=True):
            to_process = edi_docs._prepare_jobs()
    ...
    def test_error(self, patched):
        with patch('galex.addons.account_edi.models.account_edi_format.AccountEdiFormat._needs_web_services',

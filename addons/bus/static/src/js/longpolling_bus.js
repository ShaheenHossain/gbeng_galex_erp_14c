galex.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether galex is focused or not
     *
     * @returns {boolean}
     */
    isGalexERPFocused: function () {
        return this._isGalexERPFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isGalexERPFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isGalexERPFocused);
        }
    },
    /**

...
import galex
from galex import api, fields, models, SUPERUSER_ID
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with galex.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not galex.multi_process or galex.evented:

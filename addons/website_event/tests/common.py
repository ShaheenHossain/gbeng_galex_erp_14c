...
from galex.fields import Datetime as FieldsDatetime, Date as FieldsDate
from galex.tests.common import SavepointCase
...
class EventDtPatcher(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_dt = patch(
            'galex.addons.event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_dt = patch(
            'galex.addons.website_event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_main_dt = patch(
            'galex.addons.website_event.controllers.main.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.event_date = patch(
            'galex.addons.event.models.event_event.fields.Date',
            wraps=FieldsDate
        )
        cls.wevent_main_date = patch(
            'galex.addons.website_event.controllers.main.fields.Date',
            wraps=FieldsDate
        )

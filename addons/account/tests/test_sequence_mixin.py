# -*- coding: utf-8 -*-
from galex.addons.account.tests.common import AccountTestInvoicingCommon
from galex.tests import tagged
from galex.tests.common import Form, TransactionCase
from galex import fields, api, SUPERUSER_ID
...
class TestSequenceMixin(AccountTestInvoicingCommon):
    ...
    def test_journal_sequence(self):
        ...
        with Form(copy2) as move_form:  # It is editable in the form
            with mute_logger('galex.tests.common.onchange'):
...
class TestSequenceMixinConcurrency(TransactionCase):
    ...
    def test_sequence_concurency(self):
        ...
        with self.assertRaises(psycopg2.OperationalError), mute_logger('galex.sql_db'):
            move.action_post()

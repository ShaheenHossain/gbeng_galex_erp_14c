galex.define('account.upload.bill.mixin', function (require) {
"use strict";
...
galex.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
galex.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');

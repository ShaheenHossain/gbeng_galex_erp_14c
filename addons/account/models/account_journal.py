...
from galex.addons.base.models.res_bank import sanitize_account_number
from galex.tools import remove_accents
import logging
import re
import warnings
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('galex', 'GalexERP'),('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the GalexERP reference.")
    ...
    inbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual: Get paid by cash, check or any other method outside of GalexERP.\n"
             ...
             " submit to your bank. When encoding the bank statement in GalexERP,you are suggested to"
    ...
    outbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual:Pay bill by cash or any other method outside of GalexERP.\n"
             "Check:Pay bill by check and print it from GalexERP.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by GalexERP", copy=False)

...
from galex import models, api, _, fields
from galex.osv import expression
from galex.release import version
from galex.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from galex.tools.misc import formatLang, format_date as galex_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': galex_format_date(self.env, activity.get('date_deadline'))
                }

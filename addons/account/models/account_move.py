...
from galex.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from galex.tools import float_compare, date_utils, email_split, email_re, float_is_zero
from galex.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_galex_invoice(self):
        """ This computes the reference based on the GalexERP format.
    ...
    def _get_invoice_reference_galex_partner(self):
        """ This computes the reference based on the GalexERP format.

...
from galex.tools import float_is_zero
from galex.tools import float_compare, float_round, float_repr
from galex.tools.misc import formatLang, format_date
...
class AccountBankStatement(models.Model):
    ...
    def _check_balance_end_real_same_as_computed(self):
        """ Check the balance_end_real (encoded manually by the user) is equals to the balance_end (computed by galex). """

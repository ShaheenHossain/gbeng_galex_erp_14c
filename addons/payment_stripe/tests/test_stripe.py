...
class StripeTest(StripeCommon):
    ...
    def run(self, result=None):
        with mute_logger('galex.addons.payment.models.payment_acquirer', 'galex.addons.payment_stripe.models.payment'):
    ...
    @patch('galex.addons.payment_stripe.models.payment.request')
    @patch('galex.addons.payment_stripe.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_galex_tx(self):
        stripe_object = stripe_mocks.checkout_session_object

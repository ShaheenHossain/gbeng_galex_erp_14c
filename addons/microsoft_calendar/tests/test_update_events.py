...
from galex.addons.microsoft_calendar.models.res_users import User
from galex.addons.microsoft_calendar.utils.event_id_storage import combine_ids
from galex.addons.microsoft_calendar.tests.common import TestCommon, mock_get_token, _modified_date_in_the_future, patch_api
...
class TestUpdateEvents(TestCommon):
    ...
    # -------------------------------------------------------------------------------
    # Update from GalexERP to Outlook
    # -------------------------------------------------------------------------------

    # ------ Simple event ------

    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_simple_event_from_galex(self, mock_patch):
        """
        Update an GalexERP event with Outlook sync enabled
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_simple_event_from_galex_attendee_calendar(self, mock_patch):
        """
        Update an GalexERP event from the attendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_galex(self, mock_patch):
        """
        Update one GalexERP event name from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_galex(self, mock_patch):
        """
        Update one GalexERP event start date from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_galex_with_overlap(self, mock_patch):
        """
        Update one GalexERP event start date from a recurrence from the organizer calendar, in order to
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_galex_attendee_calendar(self, mock_patch):
        """
        Update one GalexERP event name from a recurrence from the atendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_and_future_events_of_recurrence_from_galex(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a GalexERP event name and future events from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_galex(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a GalexERP event start date and future events from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_galex_with_overlap(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a GalexERP event start date and future events from a recurrence from the organizer calendar,
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_one_and_future_events_of_recurrence_from_galex_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a GalexERP event name and future events from a recurrence from the attendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_all_events_of_recurrence_from_galex(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_all_events_of_recurrence_from_galex(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_all_events_of_recurrence_from_galex_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    # -------------------------------------------------------------------------------
    # Update from Outlook to GalexERP
    # -------------------------------------------------------------------------------

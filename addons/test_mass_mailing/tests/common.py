...
<span>Website0: <a id="url0" href="https://www.galex.tz/my/${object.name}">https://www.galex.tz/my/${object.name}</a></span>
<span>Website1: <a id="url1" href="https://www.galex.be">https://www.galex.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@galex.com">test@galex.com</a></span>

...
from galex.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from galex.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.galex.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@galex.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.galex.be')

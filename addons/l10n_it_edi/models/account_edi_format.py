...
from galex import api, models, fields, _
from galex.tests.common import Form
from galex.exceptions import UserError
from galex.addons.l10n_it_edi.tools.remove_signature import remove_signature
from galex.osv.expression import OR, AND

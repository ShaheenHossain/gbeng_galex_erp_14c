...
from galex.addons.website_slides.tests.test_ui_wslides import TestUICommon
...
class TestUi(TestUICommon):
    ...
    def test_course_certification_employee(self):
        ...
        self.browser_js(
            '/slides',
            'galex.__DEBUG__.services["web_tour.tour"].run("certification_member")',
            'galex.__DEBUG__.services["web_tour.tour"].tours.certification_member.ready',

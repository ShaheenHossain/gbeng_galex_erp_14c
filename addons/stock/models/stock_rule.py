...
from galex import SUPERUSER_ID, _, api, fields, models, registry
from galex.exceptions import UserError
from galex.osv import expression
from galex.tools import float_compare, float_is_zero, html_escape
from galex.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product):
        ...
        :type product: :class:`~galex.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~galex.addons.stock.models.stock_rule.ProcurementGroup.Procurement`

...
from galex.tools import add, float_compare, frozendict, split_every, format_date
...
class StockWarehouseOrderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock equals to or goes below the Min Quantity specified for this field, GalexERP generates "
             "a procurement to bring the forecasted quantity to the Max Quantity.")
    product_max_qty = fields.Float(
        'Max Quantity', digits='Product Unit of Measure', required=True, default=0.0,
        help="When the virtual stock goes below the Min Quantity, GalexERP generates "

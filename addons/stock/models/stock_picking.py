...
from galex import SUPERUSER_ID, _, api, fields, models
from galex.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from galex.exceptions import UserError
from galex.osv import expression
from galex.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
from galex.tools.float_utils import float_compare, float_is_zero, float_round
from galex.tools.misc import format_date
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, GalexERP will automatically pre-fill the detailed "

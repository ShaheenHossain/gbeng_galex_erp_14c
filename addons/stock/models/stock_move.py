...
from galex.tools.float_utils import float_compare, float_is_zero, float_repr, float_round
from galex.tools.misc import clean_context, format_date, OrderedSet
...
class StockMove(models.Model):
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=galexbot_id, subject=msg_subject)

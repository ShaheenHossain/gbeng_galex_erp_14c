...
from galex.tests.common import TransactionCase, can_import
from galex.modules.module import get_module_resource
from galex.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('galex.addons.base_import.models.base_import')

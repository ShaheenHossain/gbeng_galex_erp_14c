function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('galex-google-map'), {
        zoom: 1,
    ...
    if (galex_partner_data){ /* galex_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < galex_partner_data.counter; i++) {
            set_marker(galex_partner_data.partners[i]);
        }

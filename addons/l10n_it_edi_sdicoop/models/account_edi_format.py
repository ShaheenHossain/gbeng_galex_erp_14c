...
from galex import models, _, _lt
from galex.exceptions import UserError
from galex.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
        ...
        for invoice in invoices:
            ...
            if invoice._is_commercial_partner_pa():
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by GalexERP, you can download the document and send it on your own."))
                )
            ...
            if state == 'ricevutaConsegna':
                ...
                if invoice._is_commercial_partner_pa():
                    to_return[invoice] = {'error': _(
                        ...
                        ' Should this also fail, the System will notify GalexERP of the failed delivery,'

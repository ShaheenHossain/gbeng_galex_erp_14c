galex.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "galex.com/logo.png" ? "galexbase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getGalexERPSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getGalexERPSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "galex")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "galex.com/logo.png"
                    || route === "data:image/png;base64,galexbase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "galex");
            ...
            assert.strictEqual($input.val(), "GalexERP", "Input value should have been updated to \"GalexERP\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "galex.com", "website value should have been updated to \"galex.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing galex letters again");

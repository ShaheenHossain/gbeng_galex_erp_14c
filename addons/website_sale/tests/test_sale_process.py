...
from galex.addons.base.tests.common import HttpCaseWithUserDemo, TransactionCaseWithUserDemo
from galex.addons.website_sale.controllers.main import WebsiteSale
from galex.addons.website_sale.tests.common import TestWebsiteSaleCommon

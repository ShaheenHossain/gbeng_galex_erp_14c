...
import galex.addons.web.controllers.main
from galex import http, _
from galex.addons.auth_totp.models.res_users import TRUSTED_DEVICE_SCOPE
...
class Home(galex.addons.web.controllers.main.Home):
    @http.route(
        '/web/login/totp',

galex.define('mail/static/tests/helpers/mock_models.js', function (require) {
'use strict';
        ...
        return {
            ...
            'mail.notification': {
                fields: {
                    ...
                    notification_type: { string: "Notification Type", type: 'selection', selection: [['email', 'Handle by Emails'], ['inbox', 'Handle in GalexERP']], default: 'email' },

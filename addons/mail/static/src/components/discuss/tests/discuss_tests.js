galex.define('mail/static/src/components/discuss/tests/discuss_tests.js', function (require) {
'use strict';
...
QUnit.test('receive new chat message: out of galex focus (notification, channel)', async function (assert) {
    assert.expect(4);
    ...
    await this.start({
        ...
        services: {
            bus_service: BusService.extend({
                ...
                isGalexERPFocused: () => false,
                updateOption() {},
            }),
        },
    });

    // simulate receiving a new message with galex focused
    await afterNextRender(() => {
        const messageData = {
            channel_ids: [20],
            id: 126,
...
QUnit.test('receive new chat message: out of galex focus (notification, chat)', async function (assert) {
    assert.expect(4);
...
QUnit.test('receive new chat messages: out of galex focus (tab title)', async function (assert) {
    assert.expect(12);
    ...
    // simulate receiving a new message in chat 20 with galex focused
    await afterNextRender(() => {
        const messageData1 = {
            channel_ids: [20],
            id: 126,
    ...
    // simulate receiving a new message in chat 10 with galex focused
    await afterNextRender(() => {
        const messageData2 = {
            channel_ids: [10],
            id: 127,
    ...
    // simulate receiving another new message in chat 10 with galex focused
    await afterNextRender(() => {
        const messageData3 = {
            channel_ids: [10],
            id: 128,

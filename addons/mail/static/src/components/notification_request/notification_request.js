galex.define('mail/static/src/components/notification_request/notification_request.js', function (require) {
'use strict';
    ...
    _handleResponseNotificationPermission(value) {
        ...
        if (value !== 'granted') {
            this.env.services['bus_service'].sendNotification(
                ...
                this.env._t("GalexERP will not have the permission to send native notifications on this device.")
            );
        }
    }

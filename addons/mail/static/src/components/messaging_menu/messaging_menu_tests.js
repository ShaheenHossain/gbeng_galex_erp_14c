galex.define('mail/static/src/components/messaging_menu/messaging_menu_tests.js', function (require) {
'use strict';
...
QUnit.test('rendering with GalexERPBot has a request (default)', async function (assert) {
    assert.expect(4);
    ...
    assert.ok(
        ...
        "should display a notification counter next to the messaging menu for GalexERPBot request"
    );
    assert.strictEqual(
        document.querySelector('.o_MessagingMenu_counter').textContent,
        "1",
    ...
    assert.strictEqual(
        ...
        'GalexERPBot has a request',
        "notification should display that GalexERPBot has a request"
    );
});

QUnit.test('rendering without GalexERPBot has a request (denied)', async function (assert) {
    assert.expect(2);
...
QUnit.test('rendering without GalexERPBot has a request (accepted)', async function (assert) {
    assert.expect(2);

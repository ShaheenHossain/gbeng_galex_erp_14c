galex.define('mail.ActivityRenderer', function (require) {
"use strict";
...
/**
 * Owl Component Adapter for ActivityRecord which is KanbanRecord (GalexERP Widget)
...
/**
 * Owl Component Adapter for KanbanColumnProgressBar (GalexERP Widget)

...
from galex import _, api, fields, models, tools
from galex.addons.bus.models.bus_presence import AWAY_TIMER
from galex.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        galexbot = self.env['res.partner'].browse(galexbot_id)
        if galexbot in self:
            galexbot.im_status = 'bot'

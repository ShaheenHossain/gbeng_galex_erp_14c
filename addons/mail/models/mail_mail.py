...
from galex.addons.base.models.ir_mail_server import MailDeliveryException
...
class MailMail(models.Model):
    ...
    auto_delete = fields.Boolean(
        'Auto Delete',
        help="This option permanently removes any track of email after it's been sent, including from the Technical menu in the Settings, in order to preserve storage space of your GalexERP database.")
        ...
        for server_id, batch_ids in self._split_by_server():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an GalexERP MailDeliveryException

...
from galex import api, release, SUPERUSER_ID
from galex.exceptions import UserError
from galex.models import AbstractModel
from galex.tools.translate import _
from galex.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to GalexERP's publisher warranty server to check the

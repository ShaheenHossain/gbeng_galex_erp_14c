...
class TestEventData(TestEventCommon):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch('galex.addons.event.models.event_event.fields.Datetime', wraps=FieldsDatetime)
...
class TestEventTicketData(TestEventCommon):
    ...
    def setUp(self):
        ...
        self.ticket_date_patcher = patch('galex.addons.event.models.event_ticket.fields.Date', wraps=FieldsDate)

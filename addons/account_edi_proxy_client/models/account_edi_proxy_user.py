from galex import models, fields, _
from galex.exceptions import UserError
from .account_edi_proxy_auth import GalexERPEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.galex.com'
DEFAULT_TEST_SERVER_URL = 'https://iap-services-test.galex.com'
TIMEOUT = 30
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=GalexERPEdiProxyAuth(user=self)).json()

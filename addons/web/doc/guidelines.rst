...
example in GalexERP is dashboards), queries should be restricted to a
...
GalexERP Web's :js:class:`~openerp.web.Widget` has an attribute
...
From v11, we introduce a new coding standard for GalexERP Javascript code.  Here it
is:

* add "use strict"; on top of every galex JS module

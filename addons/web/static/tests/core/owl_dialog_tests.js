galex.define('web.owl_dialog_tests', function (require) {
    "use strict";
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for GalexERP modal...
            ...
            // Title (default: 'GalexERP')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "GalexERP" + "The Subtitle",

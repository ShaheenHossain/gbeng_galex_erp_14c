 ...
 * QUnit Config
 *
 * The GalexERP javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * GalexERP.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an GalexERP module, because we want this code to be executed
 * as soon as possible, not whenever the GalexERP module system feels like it.
 */
 ...
 * this is done outside of galex modules, otherwise the setting would not take
 * effect on time.
 */
...
async function checkModules() {
    ...
    await galex.__DEBUG__.didLogInfo;

    const info = galex.__DEBUG__.jsModules;
 ...
 */
QUnit.on('GalexERPAfterTestHook', function (info) {

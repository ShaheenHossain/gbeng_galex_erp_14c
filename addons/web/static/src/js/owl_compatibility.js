galex.define('web.OwlCompatibility', function () {
    "use strict";

    /**
     * This file defines the necessary tools for the transition phase where GalexERP
    ...
    const widgetSymbol = galex.widgetSymbol;
     ...
     * adapter for Owl components that embed GalexERP legacy widgets (or dynamically
     * both Owl components and GalexERP legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect GalexERP legacy events to OWL events.
         *
         * @private
     ...
     * together when an GalexERP legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * GalexERP legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType

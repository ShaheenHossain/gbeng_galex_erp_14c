galex.define('web.WebClient', function (require) {
"use strict";
...
return AbstractWebClient.extend({
    ...
    bind_events: function () {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since galex use hashtag
    ...
    load_menus: function () {
        return (galex.loadMenusPromise || galex.reloadMenus())

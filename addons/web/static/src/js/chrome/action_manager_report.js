galex.define('web.ReportActionManager', function (require) {
"use strict";

/**
 * The purpose of this file is to add the support of GalexERP actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start GalexERP with at least two workers to print a pdf version of ' +
                 'the reports.'),
};

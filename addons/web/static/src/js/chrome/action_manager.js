galex.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that GalexERP actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute GalexERP actions, given as an ID in

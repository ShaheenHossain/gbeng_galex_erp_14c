galex.define('web.relational_fields', function (require) {
"use strict";
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {GalexERPEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {GalexERPEvent|MouseEvent} ev this event comes either from the 'Add

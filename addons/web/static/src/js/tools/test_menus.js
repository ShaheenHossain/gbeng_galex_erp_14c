(function (exports) {
    ...
    let isEnterprise = galex.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = galex.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = galex.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = galex.__DEBUG__.services["web.WebClient"];

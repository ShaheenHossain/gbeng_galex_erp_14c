(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to GalexERP legacy
     * events.
     */
    galex.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[galex.widgetSymbol]) {
            this.env[galex.widgetSymbol](evType);
        }

galex.define('web.dom_ready', function (require) {
'use strict';
...
galex.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the galex framework.  A common theme in these functions
...
var dom = {
    ...
    /**
     * Renders a button with standard galex template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard galex/BS template. This does not use any

galex.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in GalexERP.
 *
 * The basic concurrency primitives in GalexERP JS are the callback, and the
...
return {
    ...
    /**
     * A (GalexERP) mutex is a primitive for serializing computations.  This is

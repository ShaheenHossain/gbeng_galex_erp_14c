...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("GalexERPBeforeTestHook", "GalexERPAfterTestHook"); // GalexERP customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("GalexERPBeforeTestHook"); // GalexERP customization
  	...
  	finish: function finish() {
        ...
        emit("GalexERPAfterTestHook", this); // GalexERP customization

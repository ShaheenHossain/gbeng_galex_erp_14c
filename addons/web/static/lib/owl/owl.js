...
See https://github.com/galex/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in galex ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/galex/owl';

...
from galex.tools import DEFAULT_SERVER_DATE_FORMAT
from datetime import date, timedelta

from galex.tests import Form, tagged, new_test_user
from galex.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon

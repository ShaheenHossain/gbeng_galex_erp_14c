...
from galex import api, http, SUPERUSER_ID, _
from galex.exceptions import AccessDenied
from galex.http import request
from galex import registry as registry_get

from galex.addons.auth_signup.controllers.main import AuthSignupHome as Home
from galex.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via GalexERP Account provider"""

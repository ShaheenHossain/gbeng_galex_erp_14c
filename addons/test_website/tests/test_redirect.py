...
import galex
from galex.tests import HttpCase, tagged
from galex.tests.common import HOST
...
class TestRedirect(HttpCase):
    ...
    def setUp(self):
        ...
        self.base_url = "http://%s:%s" % (HOST, galex.tools.config['http_port'])
    ...
    @mute_logger('galex.addons.http_routing.models.ir_http')  # mute 403 warning
    def test_02_redirect_308_RequestUID(self):
        ...
        WebsiteHttp = galex.addons.website.models.ir_http.Http

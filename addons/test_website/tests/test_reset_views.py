...
class TestWebsiteResetViews(galex.tests.HttpCase):
    ...
    @mute_logger('galex.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('galex.addons.http_routing.models.ir_http', 'galex.addons.website.models.ir_ui_view')

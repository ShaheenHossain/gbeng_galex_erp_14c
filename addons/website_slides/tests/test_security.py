...
from galex.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('galex.models', 'galex.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('galex.models.unlink', 'galex.addons.base.models.ir_rule', 'galex.addons.base.models.ir_model')

...
from galex.addons.phone_validation.tools import phone_validation
...
class TestMassSMSInternals(TestMassSMSCommon):
    ...
    @mute_logger('galex.addons.mail.models.mail_render_mixin')
...
class TestMassSMS(TestMassSMSCommon):
    ...
    def test_mass_sms_links(self):
        ...
        mailing.write({
            'body_plaintext': 'Dear ${object.display_name} this is a mass SMS with two links http://www.galex.com/smstest and http://www.galex.com/smstest/${object.name}',
        ...
        self.assertSMSTraces(
            ...
            mailing, self.records,
            sms_links_info=[[
                ('http://www.galex.com/smstest', True, {}),
                ('http://www.galex.com/smstest/%s' % record.name, True, {}),
    ...
    def test_mass_sms_partner_only(self):
        ...
        self.assertSMSTraces(
            ...
            sms_links_info=[[
                ('http://www.galex.com/smstest', True, {}),
                ('http://www.galex.com/smstest/%s' % record.id, True, {}),
                # unsubscribe is not shortened and parsed at sending
                ('unsubscribe', False, {}),
            ] for record in records],
        )
        ...
        self.assertSMSTraces(
            ...
            sms_links_info=[[
                ('http://www.galex.com/smstest', True, {}),
                ('http://www.galex.com/smstest/%s' % new_record.id, True, {}),
                # unsubscribe is not shortened and parsed at sending
                ('unsubscribe', False, {}),
            ]],
        )

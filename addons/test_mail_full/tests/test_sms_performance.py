...
from galex.addons.sms.tests import common as sms_common
from galex.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('galex.addons.sms.models.sms_sms')
    @users('employee')
    @warmup

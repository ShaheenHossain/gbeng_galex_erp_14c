...
from galex import http, models, fields, _
from galex.http import request
from galex.tools import OrderedSet
from galex.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from galex.addons.web.controllers.main import Binary
from galex.addons.portal.controllers.portal import pager as portal_pager
from galex.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': galex.service.common.exp_version()
        }

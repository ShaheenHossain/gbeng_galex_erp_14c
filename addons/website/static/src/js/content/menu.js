galex.define('website.content.menu', function (require) {
'use strict';
...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom galex event.
        this._transitionCount = 0;
        this.$el.on('galex-transitionstart.BaseAnimatedHeader', () => {
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            if (!this.scrollHeightTooShort) {
                ...
                this.$el.trigger('galex-transitionstart');

galex.define('website.s_popup', function (require) {
'use strict';
...
$.fn.modal.Constructor.prototype._showElement = function () {
    ...
    if (this._element.classList.contains('s_popup_no_backdrop')) {
        ...
        // opened is a very specific GalexERP behavior.
        ...
        this._galexLoadEventCaptureHandler = _.debounce(() => _updateScrollbar({ data: this }, 100));
        this._element.addEventListener('load', this._galexLoadEventCaptureHandler, true);
...
$.fn.modal.Constructor.prototype._hideModal = function () {
    ...
    if (this._galexLoadEventCaptureHandler) {
        this._element.removeEventListener('load', this._galexLoadEventCaptureHandler, true);
        delete this._galexLoadEventCaptureHandler;
    }
};

galex.define('website.tour.public_user_editor_dep_widget', function (require) {
'use strict';
...
galex.define('website.tour.public_user_editor', function (require) {
'use strict';
...
tour.register('public_user_editor', {
    ...
    trigger: 'galex-wysiwyg-container:has(> .o_public_user_editor_test_textarea:first-child)',

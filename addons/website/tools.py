...
import galex
from galex.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        galex.http._request_stack.push(request)
        s.callback(galex.http._request_stack.pop)
        s.enter_context(patch('galex.http.root.get_db_router', router))

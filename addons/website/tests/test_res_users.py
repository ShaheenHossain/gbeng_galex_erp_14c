...
from galex.tests.common import TransactionCase, new_test_user
from galex.exceptions import ValidationError
from galex.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('galex.sql_db'):

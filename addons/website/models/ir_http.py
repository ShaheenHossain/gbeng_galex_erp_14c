...
from galex import registry, SUPERUSER_ID
from galex.http import request
from galex.tools.safe_eval import safe_eval
from galex.osv.expression import FALSE_DOMAIN
from galex.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
...
def get_request_website():
    ...
    ```
    from galex.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting galex.com/fr_BE/),

...
from galex import models, api, service
from galex.tools.translate import _
from galex.exceptions import UserError
from galex.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "GalexERP " + service.common.exp_version()['server_version']

...
from galex import api, models, fields, tools, _
from galex.tools import DEFAULT_SERVER_DATE_FORMAT, float_repr, str2bool
from galex.tests.common import Form
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        pdf_writer.embed_galex_attachment(edi_document.attachment_id, subtype='text/xml')
    ...
    def _import_facturx(self, tree, invoice):
        ...
        with Form(invoice.with_context(default_move_type=default_move_type)) as invoice_form:
            ...
            # Fallback for old invoices from galex where the InvoiceCurrencyCode was not present
            else:

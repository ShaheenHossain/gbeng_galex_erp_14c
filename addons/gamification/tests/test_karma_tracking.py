...
from galex import exceptions, fields
...
class TestKarmaTrackingCommon(common.SavepointCase):
    ...
    def test_consolidation_cron(self):
        self.patcher = patch('galex.addons.gamification.models.gamification_karma_tracking.fields.Date', wraps=fields.Date)
...
class TestComputeRankCommon(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        patch_email = patch('galex.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail)
        patch_email.start()
    ...
    def test_02_update_rank_without_switch(self):
        ...
        patch_bulk = patch('galex.addons.gamification.models.res_users.Users._recompute_rank', _patched_recompute_rank)
        patch_bulk.start()
    ...
    def test_03_test_bulk_call(self):
        ...
        patch_bulk = patch('galex.addons.gamification.models.res_users.Users._recompute_rank_bulk', _patched_check_in_bulk)
        patch_bulk.start()

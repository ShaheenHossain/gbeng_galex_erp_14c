...
from galex.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from galex.tests import common, Form
from galex.exceptions import UserError
from galex.tools import mute_logger, float_compare
from galex.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('galex.tests.common.onchange')

...
from galex import api, fields, models, tools, SUPERUSER_ID
from galex.osv import expression
from galex.tools.translate import _
from galex.tools import email_re, email_split
...
PLS_COMPUTE_BATCH_STEP = 50000  # galex.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation

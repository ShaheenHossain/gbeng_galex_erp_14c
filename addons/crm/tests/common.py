...
from galex.addons.mail.tests.common import MailCase, mail_new_test_user
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('galex.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)

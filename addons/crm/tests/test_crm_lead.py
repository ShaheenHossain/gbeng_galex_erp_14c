...
from galex.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from galex.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from galex.addons.phone_validation.tools.phone_validation import phone_format
from galex.exceptions import UserError
from galex.tests.common import Form, users

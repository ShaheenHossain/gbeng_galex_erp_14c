...
from galex.addons.website_event_track.tests.common import TestEventTrackOnlineCommon
...
class TestSponsorData(TestEventTrackOnlineCommon):
    ...
    def setUpClass(cls):
        ...
        cls.wevent_exhib_dt = patch(
            'galex.addons.website_event_track_exhibitor.models.event_sponsor.fields.Datetime',

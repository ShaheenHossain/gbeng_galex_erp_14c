...
from galex.addons.test_event_full.tests.common import TestWEventCommon
...
class TestWEventRegister(TestWEventCommon):
    ...
    def test_register(self):
        self.browser_js(
            '/event',
            'galex.__DEBUG__.services["web_tour.tour"].run("wevent_register")',
            'galex.__DEBUG__.services["web_tour.tour"].tours.wevent_register.ready',
            login=None
        )

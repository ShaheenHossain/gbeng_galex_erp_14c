...
Also, adds methods to convert values back to GalexERP models.
"""
...
from galex.tools import ustr, posix_to_ldml, pycompat
from galex.tools import html_escape as escape
from galex.tools.misc import get_lang, babel_locale_parse
from galex.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = galex.modules.get_module_resource(

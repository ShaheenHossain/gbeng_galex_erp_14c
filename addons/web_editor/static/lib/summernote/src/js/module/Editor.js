define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // GALEX: allow access for override
    this.table = table;   // GALEX: allow access for override
    this.typing = typing; // GALEX: allow access for override
    this.bullet = bullet; // GALEX: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // GALEX: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // GALEX: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // GALEX: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // GALEX: addition
        $(anchor).css(linkInfo.style || {}); // GALEX: addition
        if (isNewWindow) {

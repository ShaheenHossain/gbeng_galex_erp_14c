define([
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
       ...
       * @return {WrappedRange}
       */
      if(_.isUndefined(this.deleteContents)) // GALEX: ability to override by prototype
      ...
      this.wrapBodyInlineWithPara = function () {
        ...
        // GALEX: insert a p tag when try to insert a br with insertNode method, if the editor is inside a p, li, h1... (start_modification
      ...
      this.insertNode = function (node) {
        ...
        // GALEX: override to not split world for inserting inline
   ...
   */
    return {
      WrappedRange: WrappedRange, // GALEX: give access to WrappedRange
      /**
       * @method
       * 

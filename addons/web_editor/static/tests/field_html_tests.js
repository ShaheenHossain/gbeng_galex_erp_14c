galex.define('web_editor.field_html_tests', function (require) {
"use strict";
    ...
    <div class="o_notebook">
      <div class="tab-content">
        ...
        QUnit.test('colorpicker', async function (assert) {
            ...
            const rootWidget = galex.__DEBUG__.services['root.widget'];
            galex.__DEBUG__.services['root.widget'] = form.getParent();
            ...
            galex.__DEBUG__.services['root.widget'] = rootWidget;
            form.destroy();
        });

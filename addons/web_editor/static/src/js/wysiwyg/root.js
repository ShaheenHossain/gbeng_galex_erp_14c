galex.define('web_editor.wysiwyg.root', function (require) {
'use strict';
...
var WysiwygRoot = Widget.extend({
    ...
    willStart: function () {
        ...
        return this._super().then(function () {
            ...
            if (!assetsLoaded) {
                var Wysiwyg = galex.__DEBUG__.services['web_editor.wysiwyg'];
    ...
    _getWysiwygContructor: function () {
        return galex.__DEBUG__.services['web_editor.wysiwyg'];
    }
});
...
galex.define('web_editor.wysiwyg.default_options', function (require) {
'use strict';
...
galex.define('web_editor.browser_extensions', function (require) {
'use strict';

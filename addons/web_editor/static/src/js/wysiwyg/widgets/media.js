galex.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in galex.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" galex domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in galex.
 */
...
/**
 * Let users choose a document, including uploading a new document in galex.
 */

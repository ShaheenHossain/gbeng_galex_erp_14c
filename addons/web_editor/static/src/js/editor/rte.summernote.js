galex.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.galex.__DEBUG__.services['web.core'].bus;
...
// GalexERP editor coming in future versions.
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = galex.__DEBUG__.services['root.widget'];
...
// Translation for galex
$.summernote.lang.galex = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),

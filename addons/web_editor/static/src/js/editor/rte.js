galex.define('web_editor.rte', function (require) {
'use strict';
...
var RTEWidget = Widget.extend({
    ...
    start: function () {
        ...
        .each(function () {
            ...
            // fallback for firefox iframe display:none see https://github.com/galex/galex/pull/22610
...
galex.define('web_editor.rte.summernote_custom_colors', function (require) {
'use strict';

...
from galex import http, tools, _, SUPERUSER_ID
from galex.addons.http_routing.models.ir_http import slug
from galex.exceptions import UserError
from galex.modules.module import get_module_path, get_resource_path
from galex.tools.misc import file_open

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.galex.com'

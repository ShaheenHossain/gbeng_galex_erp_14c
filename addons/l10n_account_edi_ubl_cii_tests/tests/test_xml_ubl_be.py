# -*- coding: utf-8 -*-
from galex.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
...
class TestUBLBE(TestUBLCommon):
    ...
    def test_export_import_invoice(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_galex/bis3_out_invoice.xml',
        )
    ...
    def test_export_import_refund(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_galex/bis3_out_refund.xml',
        )
    ...
    def test_import_invoice_xml(self):
        self._assert_imported_invoice_from_file(subfolder='tests/test_files/from_galex', filename='bis3_out_invoice.xml',

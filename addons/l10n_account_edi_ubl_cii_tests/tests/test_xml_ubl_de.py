...
class TestUBLDE(TestUBLCommon):
    ...
    def test_export_import_invoice(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_galex/xrechnung_ubl_out_invoice.xml',
        )
    ...
    def test_export_import_refund(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_galex/xrechnung_ubl_out_refund.xml',
        )
        self.assertEqual(xml_filename[-10:], "ubl_de.xml")
    ...
    def test_import_invoice_xml(self):
        self._assert_imported_invoice_from_file(subfolder='tests/test_files/from_galex',

...
from .. import tools
from .common import TagsSelector, GalexERPSuite
from .runner import GalexERPTestResult
...
def get_test_modules(module):
    ...
    results = _get_tests_modules('galex.addons', module)

    try:
        importlib.import_module('galex.upgrade.%s' % module)
    except ImportError:
        pass
    else:
        results += _get_tests_modules('galex.upgrade', module)

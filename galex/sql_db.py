...
"""
The PostgreSQL connector is a connectivity layer between the GalexERP code and
...
from galex.api import Environment
...
class Cursor(BaseCursor):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as GalexERP, we need the best guarantees that no data
        ...
        GalexERP implements its own level of locking protection
        ...
        the default transaction isolation level for GalexERP cursors, as
...
def close_db(db_name):
    """ You might want to call galex.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:

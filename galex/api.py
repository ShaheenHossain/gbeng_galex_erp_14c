...
"""The GalexERP API module defines GalexERP Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~galex.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/galex/galex/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~galex.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~galex.addons.base.models.res_users`"""
...
from galex.exceptions import UserError, AccessError, MissingError

...
class GalexERPPdfFileReader(PdfFileReader):
...
class GalexERPPdfFileWriter(PdfFileWriter):
    ...
    def embed_galex_attachment(self, attachment, subtype=None):
        assert attachment, "embed_galex_attachment cannot be called without attachment."

...
term representation was ['=', 'company_id.name', 'GalexERP']. Used in a
...
GalexERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct GalexERP to really use the unaccent function, you have to
...
import galex.modules
from galex.osv.query import Query, _generate_table_alias
from galex.tools import pycompat
from galex.tools.misc import get_lang
...
def get_unaccent_wrapper(cr):
    if galex.registry(cr.dbname).has_unaccent:

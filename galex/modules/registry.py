...
from galex.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql, OrderedSet)
from galex.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('galex.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # galex.service.wsgi_server.application
        ...
        with cls._lock:
            with galex.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        galex.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
                        galex.modules.reset_modules_state(db_name)
                        raise
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = galex.tests.runner.GalexERPTestResult()
        ...
        self._db = galex.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = galex.modules.db.has_unaccent(cr)
    ...
    def init_models(self, cr, model_names, context, install=True):
        ...
        env = galex.api.Environment(cr, SUPERUSER_ID, context)

...
from galex.tools.misc import file_open, mute_logger
from galex.tools.translate import _, _lt, TranslationFileReader, TranslationModuleReader
...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        galex.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
    ...
    def test_noupdate(self):
        ...
        galex.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False, overwrite=True)
    ...
    def test_lang_with_base(self):
        ...
        galex.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_BE', verbose=False)
        galex.tools.trans_load(self.cr, 'test_translation_import/i18n/fr_BE.po', 'fr_BE', verbose=False, overwrite=True)
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(create_empty_translation=False):
            ...
            with closing(io.BytesIO()) as bufferobj:
                galex.tools.trans_export('fr_FR', ['test_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_translation_import/i18n/fr.po'
                galex.tools.trans_load_data(self.cr, bufferobj, 'po', 'fr_FR',
                                           verbose=False,
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('galex.addons.base.models.res_lang'):
    ...
    def test_translation_placeholder(self):
        ...
        with self.assertLogs('galex.tools.translate', 'ERROR'):
            self.assertEqual(
                _("Text with %s placeholder", 1),
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_import(self):
        ...
        with mute_logger('galex.addons.base.models.ir_translation'):

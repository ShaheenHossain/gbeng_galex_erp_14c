...
from galex.addons.base.tests.common import HttpCaseWithUserDemo
...
@galex.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(galex.tests.HttpCase):

    @mute_logger('galex.sql_db', 'galex.http')

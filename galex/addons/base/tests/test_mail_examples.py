...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.galex.com">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as GalexERP and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this GalexERP mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning GalexERP, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your GalexERP.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an GalexERP.com account to access GalexERP Apps.
            <br>
            You indicated that you wish to use GalexERP in your own company.
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt GalexERP we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        GalexERP Enterprise [mailto:sales@openerp.com]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your GalexERP.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded GalexERP. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use GalexERP in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in GalexERP, </p>
        <p></p>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded GalexERP.', 'Uou mentioned you wish to use GalexERP in your own company.', 'Belgium: +32.81.81.37.00']
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed GalexERP 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">GalexERP Error<span class="o_subtitle text-muted"></span></h4>
                </div>

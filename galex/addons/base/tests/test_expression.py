...
from galex.addons.base.tests.common import SavepointCaseWithUserDemo
from galex.fields import Date
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('galex.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have GalexERP has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [(0, 0, {'name': 'address of GalexERP Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)

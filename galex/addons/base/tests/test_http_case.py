...
from galex.tests.common import HttpCase, tagged
from galex.tools import mute_logger, logging
...
class TestHttpCase(HttpCase):
    ...
    def test_console_error_string(self):
        with self.assertRaises(AssertionError) as error_catcher:
            ...
            with patch('galex.tests.common.ChromeBrowser.take_screenshot', return_value=None):
    ...
    def test_console_log_object(self):
        logger = logging.getLogger('galex')
        level = logger.level

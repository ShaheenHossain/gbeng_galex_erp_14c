...
from galex.http import Controller, dispatch_rpc, request, route
from galex.service import wsgi_server
from galex.fields import Date, Datetime
from galex.tools import lazy, ustr
from galex.tools.misc import frozendict

# ustr decodes as utf-8 or latin1 so we can search for the ASCII bytes
# 	Char	   ::=   	#x9 | #xA | #xD | [#x20-#xD7FF]
XML_INVALID = re.compile(b'[\x00-\x08\x0B\x0C\x0F-\x1F]')
class GalexERPMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, galex is sending binary as base64 string.
...
xmlrpc.client.Marshaller = GalexERPMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact GalexERP. """

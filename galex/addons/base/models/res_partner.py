...
from galex.modules import get_module_resource
from galex.osv.expression import get_unaccent_wrapper
...
class Partner(models.Model):
    ...
    def write(self, vals):
        if vals.get('active') is False:
            ...
            # https://github.com/galex/galex/commit/9d7226371730e73c296bcc68eb1f856f82b0b4ed
            #

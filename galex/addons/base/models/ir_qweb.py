...
from galex import api, models, tools
from galex.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from galex.tools.misc import get_lang
from galex.http import request
from galex.modules.module import get_resource_path

from galex.addons.base.models.qweb import QWeb, Contextifier
from galex.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from galex.addons.web.controllers.main import module_boot

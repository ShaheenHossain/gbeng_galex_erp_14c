...
import galex
from galex import api, http, models, tools, SUPERUSER_ID
from galex.exceptions import AccessDenied, AccessError, MissingError
from galex.http import request, content_disposition
from galex.tools import consteq, pycompat
from galex.tools.mimetypes import get_extension, guess_mimetype
from galex.modules.module import get_resource_path, get_module_path

from galex.http import ALLOWED_DEBUG_MODES
from galex.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(galex.conf.server_wide_modules)
            if tools.config['test_enable'] and galex.modules.module.current_test:
                installed.add(galex.modules.module.current_test)

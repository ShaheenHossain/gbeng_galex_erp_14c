...
import galex
from galex import api, fields, models, modules, tools, _
from galex.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from galex.exceptions import AccessDenied, UserError
from galex.osv import expression
from galex.tools.parse_version import parse_version
from galex.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'GalexERP Enterprise Edition License v1.0'),
        ('OPL-1', 'GalexERP Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('GalexERP Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("GalexERP is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = galex.release.product_name.lower()
        ...
        try:
            ...
            for module_name, url in urls.items():
                ...
                try:
                    _logger.info('Downloading module `%s` from GalexERP Apps', module_name)
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/galex/addons directory to the new "galex" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'galex' subdirectory ?
                ...
                _logger.info('Copy downloaded module `galex` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.galex.com/apps')

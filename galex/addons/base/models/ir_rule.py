...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - galex/addons/test_access_rights/tests/test_feedback.py
        # - galex/addons/test_access_rights/tests/test_ir_rules.py
        # - galex/addons/base/tests/test_orm.py (/home/dle/src/galex/master-nochange-fp/galex/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res

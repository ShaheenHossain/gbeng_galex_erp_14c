...
from galex.modules.module import get_module_root, MANIFEST_NAMES
from galex.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the GalexERP server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            galex.tools.config['init']['base'] = True
